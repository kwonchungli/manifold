...
from GAN_Network import WGAN_test, WGAN_Swiss, WGAN_MNIST, WGAN_MNIST_V2,WGAN_MNIST_MINMAX,WGAN_MNIST_V3
from AE_Network import FIT_AE_Swiss, FIT_AE_MNIST, FIT_AE_MNIST_V2,FIT_AE_MNIST_MINMAX,FIT_AE_MNIST_V3
...
def main():
    ...
    with tf.Session(config = config) as sess:
        ...
        if train_encoder:
            print('Training matched encoder')
            myVAE.train()
        else:
            print('Loading VAE')
